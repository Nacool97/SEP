	...
	<center>
		<div>
			<form name="myform" action="vendor"
				...
				<div>
					<h1 style="color: blue;"><i>Vendor register</i></h1>
					<table class="table">
						<tr>
						...
						<tr>
							<td ><label for="vid"><b>Vendor Id <font
										color="red">*</font></b></label></td>
							<td><input type="text" placeholder="Enter vendor id"
								name="vid" id="vid" required></td>
						</tr>
						<tr>
							<td></td>
						</tr>
						...
						<tr>
							...
							<td><input type="hidden" name="actionName" value="add"></td>
						</tr>
						<tr>
							<td></td>
						</tr>
						...
						<tr>
							<td colspan="2"><input class="button" type="submit"
								value="Register Here" style="height: 50px; margin-left: 100px; border-radius: 12px;background-color:blue;"></input></td>
						</tr>
					</table>
			</form>
		</div>
		<div class="pa">
			<p style="padding-bottom: 200px;">
				<b> Already have an account?&nbsp;&nbsp;&nbsp;<a
					href="vendor_login.jsp">Sign In</a></b>
			</p>
	</center>
	</div>
	<footer>
