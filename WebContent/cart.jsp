...
<header class="header"> <img class="logo" src="./img/icon.png"
	alt="logo"></img> <a class="a" href="user?actionName=logout">Logout</a>
	<a class="a" href="userproduct?actionName=display">Home</a> </header>
<body >
		...
		<c:forEach var="product" items="${product}">
			<div
				...
				Stock: ${product.getStock()}; <a
					href="userproduct?productId=${product.getProductId()}&actionName=delete">Delete</a>
